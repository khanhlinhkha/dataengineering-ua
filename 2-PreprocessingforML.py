...
# In this section, categorical variables will be converted into numeric representations
# After feature selection, we continue with the most important 9 features (without factorization, except 'timestamp')
# Before running the code this part should be commented until 'columns to keep'
...
print(top_features)
#--> 'Primary Type', 'FBI Code', 'Description', 'IUCR', 'timestamp', 'Location', 'Location Description', 'Block', 'Arrest'
...
location_mapping = {
    'RESIDENCE': ['RESIDENCE', 'APARTMENT', 'RESIDENCE PORCH/HALLWAY', 'CHA APARTMENT', 'RESIDENCE-GARAGE', 'HOUSE', 'COACH HOUSE', 'ROOMING HOUSE'],
    'OTHER': ['OTHER', 'ALLEY', 'VACANT LOT/LAND', 'VACANT LOT', 'PARK PROPERTY', 'RAILROAD PROPERTY', 'FOREST PRESERVE', 'WOODED AREA', 'JUNK YARD/GARBAGE DUMP', 'TRAILER', 'RIVER BANK'],
    'COMMERCIAL': ['GAS STATION', 'COMMERCIAL / BUSINESS OFFICE', 'SMALL RETAIL STORE', 'DEPARTMENT STORE', 'APPLIANCE STORE', 'HOTEL/MOTEL', 'MEDICAL/DENTAL OFFICE', 'SMALL RETAIL STORE', 'BARBERSHOP', 'NAIL SALON', 'DRUG STORE', 'CLEANING STORE', 'CONVENIENCE STORE', 'PAWN SHOP', 'POOLROOM', 'CLEANERS/LAUNDROMAT', 'NEWSSTAND', 'BARBER SHOP/BEAUTY SALON', 'GAS STATION DRIVE/PROP.', 'RESTAURANT', 'TAVERN/LIQUOR STORE', 'BAR OR TAVERN'],
    'STREET': ['STREET', 'SIDEWALK', 'GANGWAY', 'PARKING LOT', 'DRIVEWAY', 'DRIVEWAY - RESIDENTIAL', 'STAIRWELL', 'HIGHWAY/EXPRESSWAY', 'EXPRESSWAY EMBANKMENT', 'CTA BUS', 'CTA PLATFORM', 'CTA TRAIN', 'CTA "L" TRAIN', 'CTA PROPERTY', 'CTA BUS STOP', 'CTA "L" PLATFORM', 'CTA STATION', 'CTA TRACKS - RIGHT OF WAY', 'TAXIWAY', 'LAGOON'],
    'COMMUNITY': ['CHURCH/SYNAGOGUE/PLACE OF WORSHIP', 'DAY CARE CENTER', 'COLLEGE/UNIVERSITY GROUNDS', 'SCHOOL, PUBLIC, BUILDING', 'HOSPITAL BUILDING/GROUNDS', 'SCHOOL, PRIVATE, GROUNDS', 'COLLEGE/UNIVERSITY RESIDENCE HALL', 'COUNTY JAIL', 'FIRE STATION', 'CHURCH PROPERTY', 'LIBRARY', 'PUBLIC GRAMMAR SCHOOL', 'SCHOOL YARD', 'PUBLIC HIGH SCHOOL', 'CHURCH', 'CHA PLAY LOT', 'CHA GROUNDS', 'YMCA', 'MOVIE HOUSE/THEATER', 'BOWLING ALLEY', 'COIN OPERATED MACHINE', 'SAVINGS AND LOAN', 'SEWER', 'LIVERY STAND OFFICE', 'GARAGE/AUTO REPAIR', 'CREDIT UNION', 'CHA BREEZEWAY', 'NEWSSTAND', 'BRIDGE', 'CHA LOBBY', 'PRAIRIE', 'FUNERAL PARLOR', 'OFFICE', 'TAXI CAB', 'TRUCKING TERMINAL', 'FACTORY', 'MOTEL', 'CONVENIENCE STORE', 'LAUNDRY ROOM', 'AIRPORT PARKING LOT', 'AIRPORT TERMINAL MEZZANINE - NON-SECURE AREA', 'LIVERY AUTO', 'AIRPORT TERMINAL LOWER LEVEL - SECURE AREA', 'AIRPORT EXTERIOR - SECURE AREA', 'AIRPORT EXTERIOR - NON-SECURE AREA', 'AIRPORT TERMINAL LOWER LEVEL - NON-SECURE AREA', 'AIRPORT TERMINAL UPPER LEVEL - NON-SECURE AREA', 'AIRPORT VENDING ESTABLISHMENT', 'AIRPORT BUILDING NON-TERMINAL - NON-SECURE AREA', 'AIRPORT TRANSPORTATION SYSTEM (ATS)', 'NURSING HOME', 'VEHICLE - OTHER RIDE SERVICE', 'CLEANERS/LAUNDROMAT', 'EXPRESSWAY EMBANKMENT', 'GOVERNMENT BUILDING', 'POOLROOM', 'LAGOON']
}
